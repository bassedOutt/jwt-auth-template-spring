package com.example.jwt_auth_template.controller;
...
import static com.example.jwt_auth_template.util.Util.ROLE_CLAIM;
...
public class UserController {
    ...
    public User updateUser(@RequestBody User user) {
        ...
        return userService.addRoleToUser(user.getEmail(), ROLE_USER);
    }
